...
void onInit(CBlob@ this)
{
	...
	//Damage
	this.set_f32("dmgmult", 10.0f);
	this.set_f32("rangemult", 2.0f);
	this.set_f32("speedmult", 5.0f); //The higher this is, the slower it goes.
	...
	//Preventing num:
	this.set_u16("cancelnum", 2 * 5 * 7); //2 * 3 * 5 * 7 * 11 (2310) allows everything. Currently, this only affects archer's arrow shots though.
