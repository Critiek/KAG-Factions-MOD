...
void onInit(CBlob@ this)
{
	if (getNet().isServer())
	{
		this.server_SetTimeToDie(400 + XORRandom(60)); //Felt like increasing this a little.
...
bool doesCollideWithBlob(CBlob@ this, CBlob@ blob)
{
	...
	{
		return true; //stackable logs. I'm a genius ;)
	}
	if(blob.hasTag("raider")) //Only raiders can abuse log ladders.
	{
		return true;
	}
	bool thrown = false;
