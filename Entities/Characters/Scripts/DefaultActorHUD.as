...
void renderEquip(CBlob@ blob, Vec2f origin)
{
	...
	GUI::DrawText("Defence Percentage: " + int(blob.get_f32("defence_multiplier") * 100) + "%", origin, SColor(255, 0, 0, 0));
	origin.y -= 10;
	GUI::DrawText("Attack Damage: " + blob.get_f32("dmgmult"), origin, SColor(255, 0, 0, 0));
	origin.y -= 10;
	GUI::DrawText("Attack Speed: " + blob.get_f32("speedmult"), origin, SColor(255, 0, 0, 0));
	origin.y -= 10;
	GUI::DrawText("Attack Range: " + blob.get_f32("rangemult"), origin, SColor(255, 0, 0, 0));
	origin.y -= 10;
}
