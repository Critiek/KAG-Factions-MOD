//Explosion.as without all the bullshit that ultra triggers me for no honest reason :P
//MANNLYYYExplode.as - MANLY Explosions >:C C:< >:C C:< >:C C:< >:C C:< C>:
...
void Explode(CBlob@ this, f32 radius, f32 damage)
{
	...
	ExplodePos(this, radius, damage, pos);
}
void ExplodePos(CBlob@ this, f32 radius, f32 damage, Vec2f pos)
{
